...
import vn.vietmap.rctmgl.events.MapUserTrackingModeEvent;
import vn.vietmap.rctmgl.events.MapChangeEvent;
import vn.vietmap.rctmgl.location.LocationManager;
import vn.vietmap.rctmgl.location.UserLocation;
import vn.vietmap.rctmgl.location.UserLocationVerticalAlignment;
import vn.vietmap.rctmgl.location.UserTrackingMode;
import vn.vietmap.rctmgl.location.UserTrackingState;
...
public class RCTMGLCamera extends AbstractMapFeature {
    ...
    private void setInitialCamera() {
        if (mDefaultStop != null) {
            ...
            mDefaultStop.setMode(vn.vietmap.rctmgl.components.camera.constants.CameraMode.NONE);
