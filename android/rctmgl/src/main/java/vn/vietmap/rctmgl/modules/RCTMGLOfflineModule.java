package vn.vietmap.rctmgl.modules;
...
// import vn.vietmap.vietmapsdk.constants.Style;
import vn.vietmap.rctmgl.events.IEvent;
import vn.vietmap.rctmgl.events.OfflineEvent;
import vn.vietmap.rctmgl.events.constants.EventTypes;
import vn.vietmap.rctmgl.utils.ConvertUtils;
...
public class RCTMGLOfflineModule extends ReactContextBaseJavaModule {
    ...
    public void createPack(ReadableMap options, final Promise promise) {
        ...
        final OfflineManager offlineManager =  OfflineManager.Companion.getInstance (mReactContext);
    ...
    public void setTileCountLimit(int tileCountLimit) {
        OfflineManager offlineManager = OfflineManager.Companion.getInstance(mReactContext);
