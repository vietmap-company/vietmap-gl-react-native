...
| mapStyle | `string \| object` | `none` | `false` | Style for map - either a URL or a Style JSON . Default: `StyleURL.Default` |
...
| attributionEnabled | `boolean` | `false` | `false` | Enable/Disable attribution on map.<br/><br/>This must be enabled for Mapbox-hosted tiles and styles. Please refer to the Mapbox Terms of Service.<br/>Other providers do not require this. |
