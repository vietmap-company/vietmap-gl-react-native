...
exports.addVietmapInstallerBlock = addVietmapInstallerBlock;
...
function addVietmapInstallerBlock(src, blockName) {
    return (0, generateCode_1.mergeContents)({
...
const withVietmap = config => {
    config = withExcludedSimulatorArchitectures(config);
    return withCocoaPodsInstallerBlocks(config);
};
exports.default = (0, config_plugins_1.createRunOncePlugin)(withVietmap, pkg.name, pkg.version);
